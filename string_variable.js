...
// 6- Use template literals to create a string that includes the variables "name" and "age".
 /******* Start Your Code *********/
let info = `My name is ${name} and I am ${age} years old .`;//My name is John and I am 28 years old .
...
// 7- Use the string method "length" to find the length of the string "message".
 /******* Start Your Code *********/
let messageLength = message.length;//11
...
/******* Start Your Code *********/
let messageUppercase = message.toUpperCase();//HELLO WORLD
...
// 9- Use the string method "toLowerCase()" to convert the string "message" to lowercase.
 /******* Start Your Code *********/
let messageLowercase = message.toLowerCase();//hello world
...
// 10- Use the string method "indexOf()" to find the position of the word "JavaScript" in the string "I love learning JavaScript".
 /******* Start Your Code *********/
let stringIndex = "I love learning Javascript";//I love learning Javascript
let index = stringIndex.indexOf("Javascript");//16
...
let messageSlice = message2.slice(0,3);//mes
